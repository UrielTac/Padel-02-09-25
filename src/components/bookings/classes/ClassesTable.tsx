    ...
    <div className="w-full space-y-8">
      ...
      <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100 space-y-6">
        ...
        <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="text-sm">Gestiona tus clases y su disponibilidad</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
          ...
          <p className="text-sm text-gray-500">Administra las clases disponibles para tus clientes</p>
        </div>
                    ...
                    <div className="flex items-center gap-4" onClick={e => e.stopPropagation()}>
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>{classItem.shareableLink ? 'Copiar link de la clase' : 'Link no disponible'}</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
