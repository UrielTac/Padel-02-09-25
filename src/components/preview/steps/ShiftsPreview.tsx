...
export function ShiftsPreview({ field, theme, viewType, onNext, onPrev, isFirstStep, isLastStep, isPublicView }: ShiftsPreviewProps) {
  ...
  const availabilityParams = useMemo(() => ({
    ...
    branchId: branchId || ''
  }), [selectedDate, duration[0], courtFilter, selectedTime, branchId]);
  ...
  }, [loadingSlots, slots, error, selectedDate, duration, courtFilter, selectedTime, branchId]);
  ...
  // Modificar la sección de turnos para usar los slots disponibles
